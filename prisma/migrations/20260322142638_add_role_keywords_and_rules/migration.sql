...
CREATE TABLE "new_Settings" (
    ...
    "common_rules" TEXT NOT NULL DEFAULT '',
...
INSERT INTO "new_Settings" ("allowed_levels", "allowed_roles", "blacklist", "cron_schedule", "id", "max_posts_per_group", "max_yoe", "scrape_date_from", "scrape_date_to", "scrape_lookback_hours", "target_groups", "target_keywords") SELECT "allowed_levels", "allowed_roles", "blacklist", "cron_schedule", "id", "max_posts_per_group", "max_yoe", "scrape_date_from", "scrape_date_to", "scrape_lookback_hours", "target_groups", "target_keywords" FROM "Settings";
DROP TABLE "Settings";
